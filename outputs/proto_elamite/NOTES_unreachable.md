...
## 🟡 YELLOW BANNER — fetch_status=UNREACHABLE

Live fetch returned no ATF text. Use --bundled-corpus or --synthetic.

## Probe

- Label: `live_cdli:P000001`
- N input tokens: **0**

### Header block

- tokens: 0  numerics: 0  H₁: 0  IC: 0  LZ78: 0

### Line block

- tokens: 0  numeral blocks: 0
- numeral H₁: 0  H(next|n): 0  IC: 0  LZ78: 0
