...
*Generated: 2026-07-25T20:15:46.852775+00:00*
...
- Observed mean NN: 4.4988 km
- CSR null mean NN: 4.5147 km
- Clark-Evans R: 0.9965
- z vs CSR: -0.164
- Density: 0.012698 sites/km²

## Ley-line (collinear triple) FPR analysis
- Tolerance corridor: 0.5 km
- Pairs evaluated: 500
- Observed collinear triples per pair: 2.81

### Scrambled-coordinate null
- Mean: 2.823374
- SD: 0.090183
- z: -0.148
- Empirical FPR: 0.5354 (<0.05 = beats null)

### CSR Monte-Carlo null
- Mean: 2.832303
- SD: 0.099607
- z: -0.224
- Empirical FPR: 0.6263 (<0.05 = beats null)
...
CSR synthetic data: 500 points uniformly distributed in bounding box.
Clark-Evans R=0.997, z=-0.16 — consistent with CSR expectation.

**Ley-line (collinear triple) FPR calibration:**
- Scrambled-coord null: empirical FPR = 0.5354 (threshold 0.05)
- CSR Monte-Carlo null: empirical FPR = 0.6263 (threshold 0.05)
- Observed collinear triples per pair: 2.810000
...
- Collinear triple detection is sampled (not exhaustive), capped at 500 pairs for performance.
